...
SECRET_KEY = 'django-insecure-w*71k65v!+!2tp#^=wa3+&@rj$0hpzd$hjn7z&cv4t7x4melwl'
...
# STATIC_ROOT = "/tmp/CarRent/staticfiles"  # Basic configuration when using: python manage.py collectstatic
